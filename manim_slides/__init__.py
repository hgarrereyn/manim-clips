"""manim-slides — render Manim animations as per-slide GIFs.
...
from manim_slides.scene import SlideMixin, SlideScene, ThreeDSlideScene
from manim_slides.render import render_slides
